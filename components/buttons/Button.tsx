...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const className = [
            ...
            selectedSize,
            underlineClasses,
            `transition-all text-center flex shrink-0 justify-center items-center gap-2 focus:outline-2 focus:outline-green-400 focus:outline-offset-1 ${stretch ? "w-full" : ""} ${disabled ? "opacity-30" : "cursor-pointer"} ${customClass}`,
        ].join(" ");
