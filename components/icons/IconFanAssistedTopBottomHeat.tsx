...
export default function IconFanAssistedTopBottomHeat({ size = 24 }: { size?: number }) {
    return (
        <Icon size={size}>
            <svg className='w-full h-full' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path vectorEffect="non-scaling-stroke" d="M7 17H17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path vectorEffect="non-scaling-stroke" d="M7 7H17" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
